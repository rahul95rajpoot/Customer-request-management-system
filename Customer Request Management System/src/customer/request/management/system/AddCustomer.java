...
public class AddCustomer extends JFrame implements ActionListener {
    ...
    JTextField tfname,tffname,tfmail,tfaddress,tfphone,searchField;
    JDateChooser dcdob;
    JComboBox age;
    JLabel custId;    
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if(ae.getSource() == add){
            ...
            if (name.isEmpty() || mail.isEmpty() || phone.isEmpty() || fname.isEmpty() || dob.isEmpty() || Age.isEmpty() || address.isEmpty() || cusId.isEmpty()) {
        ...
        else if (ae.getSource() == searchButton) 
        {
          ...
          String sql = "SELECT * FROM customer WHERE customer_id=" + id;
            ...
            ResultSet rs = cn.s.executeQuery(sql);              
            }
          catch(Exception e)
          {
                e.printStackTrace();
